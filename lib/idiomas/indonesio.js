...
const smsJBConexionTrue2 = () => { return `${lenguajeGB['smsAvisoEG']()}🟢 *KONEKSI SUKSES!!! ANDA DAPAT MENGHUBUNGKAN MENGGUNAKAN (ID) ATAU GUNAKAN ANDA:*`}
const smsJBConexionTrue3 = () => { return ` *ATAU ANDA DAPAT MENGGUNAKAN (ID)*`}
const smsJBCargando = (usedPrefix) => { return `${lenguajeGB['smsAvisoIIG']()}⚪ *TERHUBUNG!! SILAKAN TUNGGU PESAN SEDANG DIMUAT...*\n\n♻️ *PILIHAN YANG TERSEDIA:*\n*» ${usedPrefix}pausesb _(Hentikan Fitur Sub Bot)_*\n*» ${usedPrefix}delsession _(Hapus semua jejak Sub Bot)_*\n*» ${usedPrefix}jadibot _(Dapatkan kode QR baru untuk menjadi Sub Bot)_*`}
